...
import nlwlogo from "../images/logo.svg";
  ...
  return (
    <main className="grid min-h-screen grid-cols-2">
      <div className="relative flex flex-col items-start justify-between overflow-hidden bg-[url(../images/bg-stars.svg)] px-28 py-16">
        ...
        <a
          href=""
          className="text-le text-le flex items-center gap-3 text-left transition-colors hover:text-gray-50"
        >
          ...
          <p className="max-w-[148px] text-sm leading-snug">
            <span className="underline"> Crie uma conta</span> e salve suas
            memórias!
          </p>
        </a>
      ...
      <div className="flex flex-col bg-[url(../images/bg-stars.svg)] bg-cover p-16">
        <div className="flex flex-1 items-center justify-center">
          <p className="w-[360px] text-center leading-relaxed">
            ...
            <a href="" className="hover:gray-50 underline">
              criar agora!
            </a>
          </p>
        </div>
